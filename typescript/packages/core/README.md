...
Core intermediate-representation types, diagnostics, and parsing utilities for the valbridge toolchain.
...
- **Cross-language conversion core** -- shared parsing and IR utilities that power Zod <-> Pydantic generation
